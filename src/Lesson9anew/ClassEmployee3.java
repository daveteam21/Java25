...
public class ClassEmployee3 { //<-- class contains methods and variables
	...
	*/
			...
			ClassEmployee3 emp = new ClassEmployee3();  //<-- object emp able to access all the variables
			emp.id= 121;
			emp.name="Joe";
			emp.job="QA Tester";
			emp.Salary=100000;
			...
			ClassEmployee3 emp2 = new ClassEmployee3();
			emp2.id= 212;
			emp2.name="Ijjou";
